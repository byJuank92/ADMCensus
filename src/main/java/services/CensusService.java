...
public class CensusService {
	 ...
	 *
	 * @param idVotacion Identificador de la votacion
	 * @param username Nombre de usuario que ha creado la votacion
	 * @param fecha_inicio Fecha de inicio para la votacion
	 * @param fecha_fin Fecha de fin para la votacion
	 * @param tituloVotacion Cadena de texto con el titulo de la votacion
	 * @return census
	...
	/**
	 *
	 * Metodo para devolver un json para saber si un usuario puede votar en una determinada votacion
	 * 
	 * @param idVotacion Identificador de la votacion
	 * @param username Nombre de usuario
	 ...
	 *
	 * @param censusId Identificador del censo al que añadir el usuario
	 * @param username Creador (propietario) del censo
	 * @param username_add Nombre de usuario que se va a añadir al censo
	 */
	...
	/**
	 * 
	 * Elimina un usuario con un username determidado a un censo, cumpliendo la condicion de que el usuario no tenga voto en ese censo
	 *
	...
	/**
	 * 
	 * Metodo que devuelve un json informando sobre un determinado usuario y su estado en el voto
	 * 
	 * @param idVotacion Identificador de la votacion
	 * @param username Nombre de usuario a cerca del cual queremos obtener su estado de voto
	 * @return String
	 */
	...
	/**
	 * 
	 * Elimina un usuario con un username determidado a un censo,
	 ...
	 *
	 * @param idVotacion Identificador de la votacion sobre la que se va a buscar un censo
	 * @return census
	 */
	...
	/**
	 *
	 * Metodo creado para saber si existe una votacion activa en el rango de fechas
	 * 
